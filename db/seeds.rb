...
Toy.create({name: "Woody", description: "Local Sheriff", sku: 2321, purchase_price: 25, inventory: 5, age_range: "5+", img_url: "https://cdn-ssl.s7.disneystore.com/is/image/DisneyShopping/1231000442875?fmt=jpeg&qlt=90&wid=652&hei=652"})
Toy.create({name: "Buzz", description: "Space Ranger", sku: 2322, purchase_price: 25, inventory: 5, age_range: "5+", img_url: "https://cdn-ssl.s7.disneystore.com/is/image/DisneyShopping/6101036512835-2?fmt=jpeg&qlt=90&wid=652&hei=652"})
